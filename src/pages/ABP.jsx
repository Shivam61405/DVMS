      ...
      <Box sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={4}>
            <Paper sx={{ padding: 2, textAlign: 'center', height: '100%' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
                ...
                <Typography variant="h6" sx={{ ml: 1 }}>Haematological Module</Typography>
              </Box>
          ...
          <Grid item xs={12} md={4}>
            <Paper sx={{ padding: 2, textAlign: 'center', height: '100%' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
                ...
                <Typography variant="h6" sx={{ ml: 1 }}>Steroidal Module</Typography>
              </Box>
          ...
          <Grid item xs={12} md={4}>
            <Paper sx={{ padding: 2, textAlign: 'center', height: '100%' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
                ...
                <Typography variant="h6" sx={{ ml: 1 }}>Endocrine Module</Typography>
              </Box>
              <Button variant="text" sx={{ color: '#3b82f6' }}>More</Button>
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper sx={{ padding: 2 }}>
              <Typography variant="h6" sx={{ mb: 2 }}>Haematological Graph</Typography>
              <Line data={haematologicalData} />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper sx={{ padding: 2 }}>
              <Typography variant="h6" sx={{ mb: 2 }}>Steroidal Graph</Typography>
              <Line data={steroidalData} />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper sx={{ padding: 2 }}>
              <Typography variant="h6" sx={{ mb: 2 }}>ABP Modules</Typography>
              <Box sx={{ mb: 2 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px', border: '1px solid #ccc', borderRadius: '4px' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <img src="https://placehold.co/40x40" alt="Haematological Module Icon" style={{ width: '40px', height: '40px' }} />
                    <Typography variant="body1" sx={{ ml: 1 }}>Haematological Module</Typography>
                  </Box>
                  <Button variant="outlined" size="small">More</Button>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px', border: '1px solid #ccc', borderRadius: '4px', marginTop: '4px' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <img src="https://placehold.co/40x40" alt="Steroidal Module Icon" style={{ width: '40px', height: '40px' }} />
                    <Typography variant="body1" sx={{ ml: 1 }}>Steroidal Module</Typography>
                  </Box>
                  <Button variant="outlined" size="small">More</Button>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px', border: '1px solid #ccc', borderRadius: '4px', marginTop: '4px' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <img src="https://placehold.co/40x40" alt="Endocrine Module Icon" style={{ width: '40px', height: '40px' }} />
                    <Typography variant="body1" sx={{ ml: 1 }}>Endocrine Modules</Typography>
                  </Box>
                  <Button variant="outlined" size="small">More</Button>
                </Box>
              </Box>
          ...
          <Grid item xs={12} md={6}>
            <Paper sx={{ padding: 2 }}>
              <Typography variant="h6" sx={{ mb: 2 }}>ABP Reports</Typography>
              <TableContainer>
                <Table>
                  <TableHead>
                    <TableRow>
